...
@section('content_header')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('promocion.tabla') }}" class="color-azul">Promoción</a></li>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-verde my-4">
                    <form method="POST" action="{{ route('promocion.agregar') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 col-md-4 col-xl-3">
                                    <div class="form-group">
                                        ...
                                        <input id="fk_producto" type="text"
                                            ...
                                            value="{{ old('fk_producto') }}" autocomplete="fk_producto" autofocus>
                                        @error('fk_producto')
                                ...
                                <div class="col-12 col-md-4 col-xl-3">
                                    <div class="form-group">
                                        ...
                                        <input id="porcentaje" type="number"  min="1" max="100"
                                            ...
                                            value="{{ old('porcentaje') }}" autocomplete="porcentaje" autofocus>
                                        @error('porcentaje')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-12 col-md-4 col-xl-3">
                                    <div class="form-group">
                                        ...
                                        <input id="fecha_inicio" type="date"
                                            ...
                                            value="{{ old('fecha_inicio') }}" autocomplete="fecha_inicio" autofocus>
                                        @error('fecha_inicio')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
