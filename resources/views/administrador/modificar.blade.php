        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-verde my-4">
                    <form method="POST" action="{{ route('administrador.modificar',['id' => $usuario->id]) }}" enctype="multipart/form-data" autocomplete="off">
                        @csrf
                        <input type="hidden" name="user_ant" value="{{$usuario->email}}" />
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 col-md-4 col-xl-3">
                                    <div class="form-group">
                                        ...
                                        <input id="nombre" type="text"
                                            ...
                                            value="{{ old('nombre',$usuario->name) }}" autocomplete="nombre" autofocus>
                                        @error('nombre')
                                ...
                                <div class="col-12 col-md-4 col-xl-3">
                                    <div class="form-group">
                                        ...
                                        <input id="usuario" type="text"
                                            ...
                                            value="{{ old('usuario',$usuario->email) }}" autocomplete="usuario" autofocus>
                                        @error('usuario')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-4 col-xl-3">
                                    <div class="form-group">
                                        ...
                                        <input id="pass" type="password"
                                            ...
                                            value="{{ old('pass') }}" autocomplete="pass" autofocus autocomplete="off">
                                        @error('pass')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-12">
                                    <span>Dejar vacias las contraseñas para no modificarlas</span>
                                </div>
                            </div>
                            <div class="row mt-4">
                                ...
                                <div class="col-12 cont-permisos">
                                    @foreach ($menus as $menu)
                                        <div class="form-check">
                                            ...
                                            @if (in_array($menu->idmenu,old("permisos",$permisosArr)))
                                                checked
                                            @endif
