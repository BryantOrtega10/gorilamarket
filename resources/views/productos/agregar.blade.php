        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-verde my-4">
                    ...
                    <form method="POST" action="{{ route('producto.agregar') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 col-md-4 col-xl-3">
                                    <div class="form-group">
                                        ...
                                        <input id="cd_barras" type="text"
                                            ...
                                            value="{{ old('cd_barras') }}" autocomplete="cd_barras" autofocus>
                                        @error('cd_barras')
                                ...
                                <div class="col-12 col-md-4 col-xl-3">
                                    <div class="form-group">
                                        ...
                                        <input id="precio" type="text"
                                            ...
                                            name="precio" value="{{ old('precio') }}" autocomplete="precio" autofocus>
                                        @error('precio')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-12 col-md-4 col-xl-3">
                                    <div class="form-group">
                                        ...
                                        <input id="precioDist" type="text"
                                            ...
                                            name="precioDist" value="{{ old('precioDist') }}" autocomplete="precioDist" autofocus>
                                        @error('precioDist')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-12 col-md-4 col-xl-3">
                                    <div class="form-group">
                                        ...
                                        <input id="unidades" type="number" min="0"
                                            ...
                                            value="{{ old('unidades') }}" autocomplete="unidades" autofocus>
                                        @error('unidades')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-12 col-md-4 col-xl-3">
                                    <div class="form-group">
                                        ...
                                        <input id="descripcion" type="text"
                                            ...
                                            name="descripcion" value="{{ old('descripcion') }}" autocomplete="descripcion"
                                            autofocus>
                                        @error('descripcion')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="col-12 col-md-4 col-xl-3">
                                    <div class="form-group">
                                        ...
                                        <select id="destacado" class="form-control @error('destacado') is-invalid @enderror"
                                            name="destacado">
                                            <option value="0" @if (old('destacado') == '0') selected @endif>NO
                                            </option>
                                            <option value="1" @if (old('destacado') == '1') selected @endif>SI
                                            </option>
                                        </select>
                                        @error('destacado')
                                            <span class="invalid-feedback" role="alert">
                                        ...
                                        <select id="cat_sup" class="form-control @error('cat_sup') is-invalid @enderror"
                                            ...
                                            @foreach ($categorias as $categoria)
                                                <option value="{{ $categoria->idcategorias }}"
                                                    @if (old('cat_sup') == $categoria->idcategorias) selected @endif>
                                                    {{ $categoria->nombre }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-12 col-md-4 col-xl-3">
                                    <div class="form-group">
                                        ...
                                        <select id="fk_categorias"
                                            class="form-control @error('fk_categorias') is-invalid @enderror" disabled
                                            name="fk_categorias">
                                            <option value="" class="d-none">Seleccione</option>
                                            @foreach ($sub_categorias as $sub_categoria)
                                                <option value="{{ $sub_categoria->idcategorias }}"
                                                    @if (old('fk_categorias') == $sub_categoria->idcategorias) selected @endif>
                                                    {{ $categoria->nombre }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-12 col-md-4 col-xl-3">
                                    <div class="form-group">
                                        ...
                                        <input id="orden" type="number" max="999" min="0"
                                            ...
                                            value="{{ old('orden', '999') }}" autocomplete="orden" autofocus>
                                        @error('orden')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-12 col-md-4 col-xl-3">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" name="fotos[]" id="fotos" multiple
                                            accept="image/*">
                                        <label class="custom-file-label" for="fotos">Selecciona imagenes</label>
                                    </div>
                                </div>
