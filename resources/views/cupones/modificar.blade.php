...
@section('title', 'Modificar cupón')

@section('plugins.JQueryNumberFormat', true)

@section('content_header')
    <h1>Modificar cupón</h1>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-verde my-4">
                    <form method="POST" action="{{ route('cupones.modificar',['id' => $cupon->idcupon]) }}" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 col-md-4 col-xl-3">
                                    <div class="form-group">
                                        ...
                                        <input id="cupon" type="text"
                                            ...
                                            value="{{ old('cupon',$cupon->cupon) }}" autocomplete="cupon" autofocus>
                                        @error('cupon')
                                ...
                                <div class="col-12 col-md-4 col-xl-3">
                                    <div class="form-group">
                                        ...
                                        <input id="no_cupones" type="number" min="1"
                                            ...
                                            value="{{ old('no_cupones',$cupon->no_cupones) }}" autocomplete="no_cupones" autofocus>
                                        @error('no_cupones')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-12 col-md-4 col-xl-3">
                                    <div class="form-group">
                                        ...
                                        <input id="valor" type="text"
                                            class="form-control @if (old('tipoValor',$cupon->tipoValor) == '2') number-format @endif @error('valor') is-invalid @enderror"
                                            name="valor" value="{{ old('valor',$cupon->valor) }}" autocomplete="valor" autofocus>
                                        @error('valor')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-12 col-md-4 col-xl-3">
                                    <div class="form-group">
                                        ...
                                        <select id="tipoValor" class="form-control @error('tipoValor') is-invalid @enderror"
                                            ...
                                            <option value="1" @if (old('tipoValor',$cupon->tipoValor) == '1') selected @endif>
                                                Porcentaje</option>
                                            <option value="2" @if (old('tipoValor',$cupon->tipoValor) == '2') selected @endif>Valor
                                            </option>
                                        </select>
                                        @error('tipoValor')
                                            <span class="invalid-feedback" role="alert">
                            ...
                            <div class="row">
                                <div class="col-12 form-check">
                                    <input class="form-check-input" type="checkbox" value="1" @if (old('apFechas',$cupon->apFecha) == "1") checked @endif id="apFechas"
                                        name="apFechas">
                            ...
                            <div class="row @if (old('apFechas',$cupon->apFecha) != "1") d-none @endif" id="b-fechas">
                                <div class="col-12 col-md-4 col-xl-3">
                                    <div class="form-group">
                                        <label for="fecha_inicio" class="form-label">Fecha/Hora inicio</label>
                                        <input id="fecha_inicio" type="datetime-local"
                                            class="form-control @error('fecha_inicio') is-invalid @enderror"
                                            name="fecha_inicio" value="{{ old('fecha_inicio',$cupon->fecha_inicio) }}"
                                ...
                                <div class="col-12 col-md-4 col-xl-3">
                                    <div class="form-group">
                                        ...
                                        <input id="fecha_fin" type="datetime-local"
                                            ...
                                            value="{{ old('fecha_fin',$cupon->fecha_fin) }}" autocomplete="fecha_fin" autofocus>
                                        @error('fecha_fin')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                            ...
                            <div class="row">
                                <div class="col-12 form-check">
                                    <input class="form-check-input" type="checkbox" value="1" id="apPrecio" @if (old('apPrecio',$cupon->apPrecio) == "1") checked @endif
                                        name="apPrecio">
                            ...
                            <div class="row @if (old('apPrecio',$cupon->apPrecio) != "1") d-none @endif" id="b-precio">
                                <div class="col-12 col-md-4 col-xl-3">
                                    <div class="form-group">
                                        ...
                                        <input id="precioMin" type="text"
                                            ...
                                            name="precioMin" value="{{ old('precioMin',$cupon->precio_inicial) }}" autocomplete="precioMin"
                                            autofocus>
                                        @error('precioMin')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="col-12 col-md-4 col-xl-3">
                                    <div class="form-group">
                                        ...
                                        <input id="precioMax" type="text"
                                            ...
                                            name="precioMax" value="{{ old('precioMax',$cupon->precio_final) }}" autocomplete="precioMax"
                                            autofocus>
                                        @error('precioMax')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
